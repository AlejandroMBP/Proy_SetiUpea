...
<head>
  ...
  <title>Contact - Creative Multi-Purpose HTML5 Templates</title>
  <!-- favicon -->
      ...
      <main data-spy="scroll" data-target="#navbar-example2" data-offset="0">
        ...
        <section class="pt_banner_inner banner_px_image">
          <div class="parallax_cover">
            <img class="cover-parallax" src="../../assets/img/inner/cc.jpg" alt="image">
          </div>
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6 ml-auto">
                ...
                <div class="form_cc_four">
                  <form action="" class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Choose a Budget <span class="font-s-13 c-gray">(USD)</span></label>
                        <select class="form-control custom-select">
                      ...
                      <div class="item_upload mb-3 mb-md-0">
                        <div class="upload__file">
                          ...
                          <button type="button" class="btn btn_md_primary">
                            <i class="tio attachment c-red"></i>
                            Attach File
                          </button>
                        </div>
