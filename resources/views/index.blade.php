...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <!--Main Slider Start-->
        @include('webComponentes.sliderMenu')
        <!--Main Slider End-->
        <!-- Service Start -->
        @include('webComponentes.servicios')
        <!-- Service Start -->
        <!-- About Start -->
        <!-- About End -->
        <!-- /.client-carousel -->
        ...
        @include('webComponentes.acerdade')
        <!-- Call To Action End -->
        <!-- Feature Start -->

        <!-- Feature End -->
        <!-- Portfolio Start -->
        @include('webComponentes.profesionales')
        <!-- Portfolio End -->
        <!-- Choose Start -->

        <!-- Choose End -->
        <!-- ofertas laborales -->
        @include('webComponentes.ofertas')
        <!-- ofertas laborales -->
        <!-- Contact Start -->
        @include('webComponentes.contactos')
        <!-- Contact End -->

        @include('webComponentes.footer')
        <!-- /.main-footer -->
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="assets/images/logo-light.png" width="96"
                        height="34" alt="nisoz" /></a>
            </div>
            <!-- /.logo-box -->
