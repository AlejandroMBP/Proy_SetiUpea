        ...
        <div class="row">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="300ms">
                <div class="section-title">
                    ...
                    <h2 class="section-title__title">soporte tecnico</h2>
                </div><!-- section-title -->
                <div class="contact-two__box">
                    <div class="contact-two__box__icon"><span class="icon-phone-call"></span></div>
                    <h5 class="contact-two__box__title">tienes alguna pregunta?</h5>
                ...
                <div class="contact-two__box">
                    ...
                    <h5 class="contact-two__box__title">envianos un email</h5>
                    <p class="contact-two__box__text"><a
                ...
                <div class="contact-two__box">
                    ...
                    <h5 class="contact-two__box__title">visitanos ahora</h5>
                                ...
                                <div class="contact-two__btn-box">
                                    <button type="submit" class="nisoz-btn">
                                        <span class="nisoz-btn__shape"></span><span
                                            ...
                                            class="nisoz-btn__shape"></span><span
                                            class="nisoz-btn__shape"></span>
                                        <span class="nisoz-btn__text">enviar mensaje</span>
                                    </button>
                                </div>
                            </div>
                        </div>
